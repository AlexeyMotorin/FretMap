...
enum MusicDatabase {
    ...
    private static let popularProgressionsByScale: [String: [PopularProgression]] = [
        "ionian": [
            ...
            progression("ionian-jazz-turnaround", "Turnaround", "Intermediate", ["I", "vi", "ii", "V"], 5, .blue),
        ...
        "aeolian": [
            ...
            progression("aeolian-cinematic", "Кинематографичный минор", "Minor", ["i", "VI", "iv", "V"], 3, .red),
